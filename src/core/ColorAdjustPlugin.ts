    ...
    setTimeout(() => {
      ...
      if (greyscale) {
        ...
        const cosA = Math.cos(angle),
          sinA = Math.sin(angle)
        const r1 = cosA + (1 - cosA) / 3,
          g1 = (1 / 3) * (1 - cosA) - Math.sqrt(1 / 3) * sinA,
          b1 = (1 / 3) * (1 - cosA) + Math.sqrt(1 / 3) * sinA
        const r2 = (1 / 3) * (1 - cosA) + Math.sqrt(1 / 3) * sinA,
          g2 = cosA + (1 - cosA) / 3,
          b2 = (1 / 3) * (1 - cosA) - Math.sqrt(1 / 3) * sinA
        const r3 = (1 / 3) * (1 - cosA) - Math.sqrt(1 / 3) * sinA,
          g3 = (1 / 3) * (1 - cosA) + Math.sqrt(1 / 3) * sinA,
          b3 = cosA + (1 - cosA) / 3
